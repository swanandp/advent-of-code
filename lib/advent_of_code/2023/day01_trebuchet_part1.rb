...
FIRST_DIGIT_REGEX = /\A[^0-9]*\d/i
LAST_DIGIT_REGEX = /\d[^0-9]*\z/i

def extract_number(line)
  word = line.strip
  first_digit = word.match(FIRST_DIGIT_REGEX)[0][-1].to_i
  last_digit = word.match(LAST_DIGIT_REGEX)[0][0].to_i
  first_digit * 10 + last_digit
end

sample = %w[1abc2 pqr3stu8vwx a1b2c3d4e5f treb7uchet]
